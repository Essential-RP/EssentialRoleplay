...
Config.RareLootItem = 'fleecaphone' -- Rare loot item
...
Config.DeliveryCoords = {  -- Locations for the scrapyards **Chosen from random every time you start a new job**
    [1] = {
    coords = vector4( 256.26956176758, 2578.1479492188, 45.23588180542, 93.711402893066),
    },
    [2] = {
    coords = vector4(1641.0671386719, 4838.4702148438, 42.024444580078, 189.00039672852 ),
    },
    [3] = {
    coords = vector4(-971.07360839844, -1963.7646484375, 13.191576004028, 314.55651855469),
    },
    [4] = {
    coords = vector4(-371.74340820313,  184.62919616699, 80.238319396973, 87.988868713379),
    },
    [5] = {
    coords = vector4(1205.2525634766, -1261.5847167969, 35.226722717285, 179.0950012207),
    },
}
...
Config.VehicleCoords = {        -- Locations of where the vehicle can spawn **Chosen from random every time you start a new job**
    ...
    [46] = {coords = vector4(-68.593788146973, 898.03857421875, 235.56652832031, 114.10948944092)},
