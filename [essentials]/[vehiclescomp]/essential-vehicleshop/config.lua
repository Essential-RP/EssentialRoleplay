...
Config.FinanceZone = vector3(-32.91, -1097.28, 27.27)-- Where the finance menu is located
Config.PaymentWarning = 10 -- time in minutes that player has to make payment before repo
Config.PaymentInterval = 24 -- time in hours between payment being due
Config.MinimumDown = 55 -- minimum percentage allowed down
Config.MaximumPayments = 8 -- maximum payments allowed
...
Config.Shops = {
    ['pdm'] = {
        ...
        ['VehicleSpawn'] = vector4(-14.408053398132, -1093.4520263672, 26.324464797974, 160.64190673828), -- Spawn location when vehicle is bought
        ['TestDriveSpawn'] = vector4(-56.79, -1109.85, 26.43, 71.5), -- Spawn location for test drive
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-46.4, -1094.31, 25.37, 194.62), -- where the vehicle will spawn on display
                defaultVehicle = 'schafter2',
                chosenVehicle = 'schafter2'
            },
            [2] = {
                coords = vector4(-51.04, -1095.62, 25.40, 225.26),
                defaultVehicle = 'sultan',
                chosenVehicle = 'sultan'
            },
            [3] = {
                coords = vector4(-46.81, -1101.74, 25.40, 296.43),
                defaultVehicle = 'komoda',
                chosenVehicle = 'komoda'
            },
            [4] = {
                coords = vector4(-41.32, -1095.31, 25.40, 198.05),
                defaultVehicle = 'buffalo',
                chosenVehicle = 'buffalo'
            },
            [5] = {
                coords = vector4(-39.52, -1102.43, 25.40, 303.96),
...
--[[     ['Luxury'] = {
    ...
    ['police'] = {
        ...
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the shop
            vector2(460.0207824707, -1012.9877319336),
            vector2(460.01129150391, -1012.9780883789),
            vector2(466.13272094727, -1012.9619140625),
            vector2(465.78237915039, -1021.2469482422),
            },
            ['minZ'] = 28.08,  -- min height of the shop zone
            ['maxZ'] = 32.08,  -- max height of the shop zone
        ...
        ['Location'] = vector3(-45.67, -1098.34, 26.42), -- Blip Location
        ['ReturnLocation'] = vector3(-44.74, -1082.58, 26.68), -- Location to return vehicle, only enables if the vehicleshop has a job owned
        ['VehicleSpawn'] = vector4(456.1, -1024.87, 28.1, 59.17), -- Spawn location when vehicle is bought
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(465.16, -1017.73, 27.73, 359.89),
                defaultVehicle = '11cvpi',
                chosenVehicle = '11cvpi',
            },
        },
    },
    --[[ ['boats'] = {
