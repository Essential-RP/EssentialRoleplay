...
--[[ 
  ...
  Set to 'qb' for base essential-policejob alerts 
...
Config.BackRoom = {}
Config.BackRoom.Item = 'thermite' -- item to remove\check for when entering the back room
Config.BackRoom.Thermite = {
  time = 60, -- time the hack displays for \\ half being showing the puzzle and the other solving
