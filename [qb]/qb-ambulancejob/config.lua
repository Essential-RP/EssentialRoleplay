...
Config.BillCost = 1750 -- Price that players are charged for using the hospital check-in system
...
Config.PainkillerInterval = 15 -- Set the length of time painkillers last (per one)
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
        ...
        [2] = vector3(311.77, -593.48, 43.28),
	    -- [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(310.17, -597.8, 43.28),
