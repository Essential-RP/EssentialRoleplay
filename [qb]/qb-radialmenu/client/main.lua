...
--         items = {}
--     }
--     if Config.Police[PlayerData.job.name] and next(Config.Police[PlayerData.job.name]) then
--         JobMenu.items = Config.Police[PlayerData.job.name]
--     end
...
local function SetupVehicleMenu()
    local VehicleMenu = {
        ...
        icon = 'car',
        type = 'client',
        event = 'essential-carmenu:veh:options',
        shouldClose = true,
    }
