...
zoneName = nil
PlayerData, previousSkinData, StoreBlips = {}, {}, {}
...
RegisterNetEvent('qb-clothing/client/getOutfits', function(Job, Grade)
    local Gender = "male"
...
RegisterNetEvent("qb-clothes/client/loadPlayerSkin", function()
    TriggerServerEvent('qb-clothes/loadPlayerSkin')
end)
...
RegisterNUICallback('saveOutfit', function(data, cb)
    ...
    TriggerServerEvent('qb-clothes/saveOutfit', data.outfitName, model, Config.SkinData)
    cb('ok')
end)
...
RegisterNUICallback('toggleVariation', function(data, cb)
    ...
    TriggerEvent('qb-clothing/client/loadOutfit', ClothingData)
    cb('ok')
end)
...
local inSpawn = false
RegisterNetEvent("qb-clothing:inSpawn", function(pInSpawn)
    inSpawn = pInSpawn
end)
