...
QBShared.Vehicles = {
    ...
    ['Code311cvpi'] = { -- This has to match the spawn code of the vehicle
    ['name'] = 'PD Crownvic', -- This is the display of the vehicle
    ['brand'] = 'Ford', -- This is the vehicle's brand (Ford, Chevrolet, BMW, Mercedes, etc)
    ['model'] = 'Code311cvpi', -- This must match the spawn code of the vehicle
    ['price'] = 50000, -- The price that the vehicle sells for
    ['category'] = 'Police Vehicles', -- This must match "VehicleClass" in vehicles.meta for the vehicle and must also exist in https://docs.fivem.net/natives/?_0x29439776AAA00A62
    ['categoryLabel'] = 'Police Vehicles', -- Customize for your Vehicle Shop headings (can even include spaces)
    ['hash'] = `Code311cvpi`, -- This has to match the spawn code of the vehicle and must be surrounded by backticks. Example of a Backtick: `
    ['shop'] = 'police', -- Can be a single shop or multiple shops. For multiple shops for example {'shopname1','shopname2','shopname3'}
},
